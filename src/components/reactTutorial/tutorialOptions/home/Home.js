        ...
        <div className='home__container'>
            <div className='home__content'>
                ...
                <div className='home__about__section'>
                    <p className='home__about__section__text'> <img className='home__hi__img' src={hi} alt='hi' /> This is a React app that I made so I could teach myself React. I built it based on the
                        <a href='https://www.w3schools.com/react/react_getstarted.asp' className='home__about__section--anchor'>W3schools</a> layout.
