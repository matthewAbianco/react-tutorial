        ...
        <div className='sass__container'>
            <div className='sass__content'>
                ...
                <div className='sass__section'>
                    ...
                    <p>The first is, the SCSS file we want to export our CSS from needs to begin with a "_". EG "_example.scss".</p>
                ...
                <div className='sass__section'>
                    <h2>Extend: @extend</h2>
                    <p>The @extend feature works very similarly to the @mixin and @include feature. While the @mixin requires us to specify what code we want to reuse. The @extend allows us to
